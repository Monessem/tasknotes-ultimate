...
export function SettingsView() {
  const { settings, setSettings, todos, notes, habits, habitLogs, pomodoroSessions, historyEntries } = useAppStore()
